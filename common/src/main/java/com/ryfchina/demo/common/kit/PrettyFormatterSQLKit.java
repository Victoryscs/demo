...
/**
 * PrettyFormatterSQLKit
 *
 * @author zhanjin
 * @version 1.0
 * @description: 描述
 * @create 2017/8/27 15:45
 * @since JDK 1.8
 */
public class PrettyFormatterSQLKit {
	/**
	 * 日志
	 */
	private static final Logger LOGGER = LoggerFactory.getLogger(PrettyFormatterSQLKit.class);
	 ...
	 * PrettyFormatterSQLKit().getPrettySql("select * from t_order"); System.out.println(sql); }
	 */
