...
public class SdkSecurityKit {
	...
	public static String encrypt(String data, Key key) throws Exception {
		...
		byte[] bytes = encrypt(data.getBytes(C.Charset.UTF8), key, "RSA/None/PKCS1Padding");

		return new String(Base64.encode(bytes), C.Charset.UTF8);
	}
	...
	/*
	 * public static void main(String[] args) { try { KeyPair keyPair = generateRSAKeyPair(); String privateKey =
	 * convert2String(keyPair.getPrivate()); String publicKey = convert2String(keyPair.getPublic());
	 * System.out.println("私钥：" + privateKey); System.out.println("公钥：" + publicKey);
	 *
	 * // 私钥加密 String data = "中文明文abc123"; String encryptedData = encrypt(data, convert2PrivateKey(privateKey));
	 * System.out.println("密文：" + encryptedData); String decryptedData = decrypt(encryptedData,
	 * convert2PublicKey(publicKey)); System.out.println("明文：" + decryptedData); // 公钥解密 } catch (Exception e) {
	 * e.printStackTrace(); } }
	 */
}
